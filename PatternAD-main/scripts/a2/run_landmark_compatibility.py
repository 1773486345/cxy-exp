#!/usr/bin/env python3
"""Run A2-M4's landmark and direction support compatibility experiment."""
...
from scripts.a2.generate_transition_contract import _load_json  # noqa: E402
from scripts.a2.run_transition_compatibility import run_experiment, write_result  # noqa: E402
...
DEFAULT_EXPERIMENT_CONFIG = REPO_ROOT / "config" / "a2" / "landmark_direction_m4_v1.json"
...
def main(argv: List[str] | None = None) -> int:
    ...
    summary, checkpoint = run_experiment(
        contract_config, experiment_config, model_factory=A2LandmarkCompatibility
    )
    write_result(arguments.output_dir, summary, checkpoint)
    print(
        f"A2-M4 complete: gates_passed={summary['all_gates_passed']} "
