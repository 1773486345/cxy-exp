...
MODEL_HYPER_PARAMS='{"Mlr":0.00001,"anomaly_ratio":null,"auxi_lambda":0.005,"batch_size":__BATCH_SIZE__,"catch_train_epochs":10,"cf_dim":16,"d_ff":32,"d_model":64,"dc_lambda":0.005,"dropout":0.4,"e_layers":3,"head_dim":64,"inference_patch_size":32,"inference_patch_stride":1,"lr":0.005,"n_heads":4,"patch_size":16,"patch_stride":8,"patience":3,"score_lambda":0.05,"seed":2021,"seq_len":192,"type_train_epochs":10,"joint_dim":128,"joint_layers":2,"joint_heads":4,"relation_mask_groups":4,"state_memory_size":32,"state_topk":4,"sufficient_temperature":1.0,"relation_correction_cap":2.0,"responsibility_margin":0.2,"score_margin":0.5,"synergy_margin":0.2}'
