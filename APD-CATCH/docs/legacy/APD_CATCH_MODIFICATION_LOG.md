...
本文主要记录早期 APD-CATCH、causal-state 和旧实验路线，
不代表当前 MSD-CATCH / BHD-MSD-CATCH 主线状态。

当前使用方式见：
- [APD-CATCH/README.md](../../README.md)

当前研究进展见：
- [tsad_direction_A_pattern_aware_scoring.md](../../../tsad_direction_A_pattern_aware_scoring.md)

旧 APD 路线状态见：
- [APD-CATCH/docs/legacy/APD_CATCH_LEGACY_STATUS.md](./APD_CATCH_LEGACY_STATUS.md)
